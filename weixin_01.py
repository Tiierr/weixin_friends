...
def main():
    ...
    for Member in MemberList:
        ...
        '''
        name = os.getcwd() + '/friendImage/Image'+str(imageIndex)+'.jpg'
        ...
        city = Member['City'].encode('utf-8')
        city = 'nocity' if city == '' else  city
        name = Member['NickName'].encode('utf-8')
        name = 'noname' if name == '' else  name
        sign = Member['Signature'].encode('utf-8')
        sign = 'nosign' if sign == '' else  sign
        remark = Member['RemarkName'].encode('utf-8')
        remark = 'noremark' if remark == '' else remark
        alias = Member['Alias'].encode('utf-8')
        alias = 'noalias' if alias == '' else alias
        nick = Member['NickName'].encode('utf-8')
        nick = 'nonick' if nick == '' else nick
        #print(name,'  ^+*+^  ',city,'  ^+*+^  ',Member['Sex'],' ^+*+^ ',Member['StarFriend'],' ^+*+^ ',sign,' ^+*+^ ',remark,' ^+*+^ ',alias,' ^+*+^ ',nick )
        li = [name,city,Member['Sex'],Member['StarFriend'],sign,remark,alias]
